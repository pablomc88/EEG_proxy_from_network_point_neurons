...
nest::RecordablesMap< mynest::iaf_bw_2003 >
  mynest::iaf_bw_2003::recordablesMap_;
...
RecordablesMap< mynest::iaf_bw_2003 >::create()
{
  ...
  insert_(
    names::V_m, &mynest::iaf_bw_2003::get_y_elem_< mynest::iaf_bw_2003::State_::V_M > );
  insert_(
    names::g_ex, &mynest::iaf_bw_2003::get_y_elem_< mynest::iaf_bw_2003::State_::G_EXC > );
  insert_(
    names::g_in, &mynest::iaf_bw_2003::get_y_elem_< mynest::iaf_bw_2003::State_::G_INH > );
...
extern "C" inline int
mynest::iaf_bw_2003_dynamics( double,
  const double y[],
  double f[],
  void* pnode )
{
  ...
  assert( pnode );
  const mynest::iaf_bw_2003& node =
    *( reinterpret_cast< mynest::iaf_bw_2003* >( pnode ) );
...
mynest::iaf_bw_2003::State_& mynest::iaf_bw_2003::State_::operator=(
  const State_& s )
{
...
void
mynest::iaf_bw_2003::Parameters_::get( DictionaryDatum& d ) const
{
...
void
mynest::iaf_bw_2003::Parameters_::set( const DictionaryDatum& d )
{
...
void
mynest::iaf_bw_2003::State_::get( DictionaryDatum& d ) const
{
  def< double >( d, names::V_m, y[ V_M ] ); // Membrane potential
}

void
mynest::iaf_bw_2003::State_::set( const DictionaryDatum& d, const Parameters_& )
{
...
void
mynest::iaf_bw_2003::init_state_( const Node& proto )
{
  const mynest::iaf_bw_2003& pr = downcast< mynest::iaf_bw_2003 >( proto );
  S_ = pr.S_;
}
...
double
mynest::iaf_bw_2003::get_normalisation_factor( double tau_rise,
...
void
mynest::iaf_bw_2003::calibrate()
{
  // ensures initialization in case mm connected after Simulate
  B_.logger_.init();

  V_.PSConInit_E = mynest::iaf_bw_2003::get_normalisation_factor(
    P_.tau_rise_AMPA, P_.tau_decay_AMPA , P_.tau_m);
  V_.PSConInit_I = mynest::iaf_bw_2003::get_normalisation_factor(
...
void
mynest::iaf_bw_2003::update( Time const& origin,
  const long from,
  const long to )
{
