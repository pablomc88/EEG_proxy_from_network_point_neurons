/*
 *  iaf_bw_2003_fr_adaptation_NMDA.cpp
 *
...
nest::RecordablesMap< mynest::iaf_bw_2003_fr_adaptation_NMDA >
  mynest::iaf_bw_2003_fr_adaptation_NMDA::recordablesMap_;
...
template <>
void
RecordablesMap< mynest::iaf_bw_2003_fr_adaptation_NMDA >::create()
{
  // use standard names whereever you can for consistency!
  insert_(
    names::V_m, &mynest::iaf_bw_2003_fr_adaptation_NMDA::get_y_elem_< mynest::iaf_bw_2003_fr_adaptation_NMDA::State_::V_M > );
  insert_(
    names::g_ex, &mynest::iaf_bw_2003_fr_adaptation_NMDA::get_y_elem_< mynest::iaf_bw_2003_fr_adaptation_NMDA::State_::G_EXC > );
  insert_(
    names::g_in, &mynest::iaf_bw_2003_fr_adaptation_NMDA::get_y_elem_< mynest::iaf_bw_2003_fr_adaptation_NMDA::State_::G_INH > );
  insert_(
    names::g_NMDA, &mynest::iaf_bw_2003_fr_adaptation_NMDA::get_y_elem_< mynest::iaf_bw_2003_fr_adaptation_NMDA::State_::G_EXC_NMDA > );
  insert_(
    names::I_e, &mynest::iaf_bw_2003_fr_adaptation_NMDA::get_y_elem_< mynest::iaf_bw_2003_fr_adaptation_NMDA::State_::I_fr > );

  insert_( names::t_ref_remaining, &mynest::iaf_bw_2003_fr_adaptation_NMDA::get_r_ );
}
}
...
extern "C" inline int
mynest::iaf_bw_2003_fr_adaptation_NMDA_dynamics( double,
  const double y[],
  double f[],
  void* pnode )
{
  // a shorthand
  typedef mynest::iaf_bw_2003_fr_adaptation_NMDA::State_ S;

  // get access to node so we can almost work as in a member function
  assert( pnode );
  const mynest::iaf_bw_2003_fr_adaptation_NMDA& node =
    *( reinterpret_cast< mynest::iaf_bw_2003_fr_adaptation_NMDA* >( pnode ) );
  ...
  const double I_syn_exc = (y[ S::G_EXC_NMDA ] +  y[ S::G_EXC]) * ( V - node.P_.E_ex );
  const double I_leak = node.P_.g_L * ( V - node.P_.E_L );
  const double I_fr_adapt = y[ S::I_fr ];

  // dV_m/dt
  f[ 0 ] = ( -I_leak - I_syn_exc - I_syn_inh + node.B_.I_stim_ + node.P_.I_e - I_fr_adapt)
    / node.P_.C_m;
...
mynest::iaf_bw_2003_fr_adaptation_NMDA::Parameters_::Parameters_()
  : V_th( -52.0 )       // mV
  , V_reset( -59.0 )    // mV
  , t_ref( 2.0 )        // ms
  , g_L( 25.0 )      // nS
...
mynest::iaf_bw_2003_fr_adaptation_NMDA::State_::State_( const Parameters_& p )
  : r( 0 )
{
...
mynest::iaf_bw_2003_fr_adaptation_NMDA::State_::State_( const State_& s )
  : r( s.r )
{
...
mynest::iaf_bw_2003_fr_adaptation_NMDA::State_& mynest::iaf_bw_2003_fr_adaptation_NMDA::State_::operator=(
  const State_& s )
{
...
mynest::iaf_bw_2003_fr_adaptation_NMDA::Buffers_::Buffers_( mynest::iaf_bw_2003_fr_adaptation_NMDA& n )
  : logger_( n )
  , s_( 0 )
  , c_( 0 )
  , e_( 0 )
...
mynest::iaf_bw_2003_fr_adaptation_NMDA::Buffers_::Buffers_( const Buffers_&, mynest::iaf_bw_2003_fr_adaptation_NMDA& n )
  : logger_( n )
  , s_( 0 )
  , c_( 0 )
  , e_( 0 )
...
void
mynest::iaf_bw_2003_fr_adaptation_NMDA::Parameters_::get( DictionaryDatum& d ) const
{
...
void
mynest::iaf_bw_2003_fr_adaptation_NMDA::Parameters_::set( const DictionaryDatum& d )
{
...
void
mynest::iaf_bw_2003_fr_adaptation_NMDA::State_::get( DictionaryDatum& d ) const
{
  def< double >( d, names::V_m, y[ V_M ] ); // Membrane potential
}

void
mynest::iaf_bw_2003_fr_adaptation_NMDA::State_::set( const DictionaryDatum& d, const Parameters_& )
{
...
mynest::iaf_bw_2003_fr_adaptation_NMDA::iaf_bw_2003_fr_adaptation_NMDA()
  : Archiving_Node()
  , P_()
  , S_( P_ )
  , B_( *this )
...
mynest::iaf_bw_2003_fr_adaptation_NMDA::iaf_bw_2003_fr_adaptation_NMDA( const mynest::iaf_bw_2003_fr_adaptation_NMDA& n )
  : Archiving_Node( n )
  , P_( n.P_ )
  , S_( n.S_ )
  , B_( n.B_, *this )
...
void
mynest::iaf_bw_2003_fr_adaptation_NMDA::init_state_( const Node& proto )
{
  const mynest::iaf_bw_2003_fr_adaptation_NMDA& pr = downcast< mynest::iaf_bw_2003_fr_adaptation_NMDA >( proto );
  S_ = pr.S_;
}

void
mynest::iaf_bw_2003_fr_adaptation_NMDA::init_buffers_()
{
  ...
  B_.sys_.function = iaf_bw_2003_fr_adaptation_NMDA_dynamics;
...
double
mynest::iaf_bw_2003_fr_adaptation_NMDA::get_normalisation_factor( double tau_rise,
...
void
mynest::iaf_bw_2003_fr_adaptation_NMDA::calibrate()
{
  // ensures initialization in case mm connected after Simulate
  B_.logger_.init();

  V_.PSConInit_E = mynest::iaf_bw_2003_fr_adaptation_NMDA::get_normalisation_factor(
    P_.tau_rise_AMPA, P_.tau_decay_AMPA , P_.tau_m);
  V_.PSConInit_E_NMDA = mynest::iaf_bw_2003_fr_adaptation_NMDA::get_normalisation_factor(
    P_.tau_rise_NMDA, P_.tau_decay_NMDA , P_.tau_m);
  V_.PSConInit_I = mynest::iaf_bw_2003_fr_adaptation_NMDA::get_normalisation_factor(
...
void
mynest::iaf_bw_2003_fr_adaptation_NMDA::update( Time const& origin,
  const long from,
  const long to )
{
...
void
mynest::iaf_bw_2003_fr_adaptation_NMDA::handle( SpikeEvent& e )
{
...
void
mynest::iaf_bw_2003_fr_adaptation_NMDA::handle( CurrentEvent& e )
{
  assert( e.get_delay() > 0 );
...
void
mynest::iaf_bw_2003_fr_adaptation_NMDA::handle( DataLoggingRequest& e )
{
  B_.logger_.handle( e );
}
