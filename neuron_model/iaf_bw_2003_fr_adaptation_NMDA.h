/*
 *  iaf_bw_2003_fr_adaptation_NMDA.h
 *
...
#ifndef iaf_bw_2003_fr_adaptation_NMDA_H
#define iaf_bw_2003_fr_adaptation_NMDA_H
...
namespace mynest
{
   ...
   */
  extern "C" int iaf_bw_2003_fr_adaptation_NMDA_dynamics( double, const double*, double*, void* );

/* BeginDocumentation
Name: iaf_bw_2003_fr_adaptation_NMDA - Integrate-and-fire neuron model with conductance-based
                    synapse described by a delayed difference of exponentials [1,2] and with
                    firing-rate adaptation. Exc. synapses are mediated by both AMPA and NMDA
                    receptors.
...
class iaf_bw_2003_fr_adaptation_NMDA : public nest::Archiving_Node
{
public:
  /**
   ...
   */
  iaf_bw_2003_fr_adaptation_NMDA( const iaf_bw_2003_fr_adaptation_NMDA& );
...
private:
  ...
  friend int iaf_bw_2003_fr_adaptation_NMDA_dynamics( double, const double*, double*, void* );


  // The next two classes need to be friends to access the State_ class/member
  friend class nest::RecordablesMap< iaf_bw_2003_fr_adaptation_NMDA >;
  friend class nest::UniversalDataLogger< iaf_bw_2003_fr_adaptation_NMDA >;
  ...
  struct Parameters_
  {
    ...
    double S_act_NMDA;     // mV, fraction of the exc. charge mediated by NMDA receptors
    double tau_m;         // !< Membrane time constant in ms
    double I_e;          //!< Constant Current in pA
    double tau_sfa;  //!< spike-frequency adaptation (sfa) time constant
    double q_sfa;    //!< spike-frequency adaptation (sfa) quantal current
                     //!< increase in pA
  ...
  struct Buffers_
  {
    Buffers_( iaf_bw_2003_fr_adaptation_NMDA& );
    Buffers_( const Buffers_&, iaf_bw_2003_fr_adaptation_NMDA& );
    ...
    nest::UniversalDataLogger< iaf_bw_2003_fr_adaptation_NMDA > logger_;
  ...
  static nest::RecordablesMap< iaf_bw_2003_fr_adaptation_NMDA > recordablesMap_;

};

inline nest::port
mynest::iaf_bw_2003_fr_adaptation_NMDA::send_test_event( nest::Node& target,
...
inline nest::port
mynest::iaf_bw_2003_fr_adaptation_NMDA::handles_test_event( nest::SpikeEvent&,
  nest::port receptor_type )
{
  // You should usually not change the code in this function.
...
inline nest::port
mynest::iaf_bw_2003_fr_adaptation_NMDA::handles_test_event( nest::CurrentEvent&,
  nest::port receptor_type )
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest::port
mynest::iaf_bw_2003_fr_adaptation_NMDA::handles_test_event( nest::DataLoggingRequest& dlr,
  nest::port receptor_type )
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void
iaf_bw_2003_fr_adaptation_NMDA::get_status( DictionaryDatum& d ) const
{
...
inline void
iaf_bw_2003_fr_adaptation_NMDA::set_status( const DictionaryDatum& d )
{
...
#endif /* #ifndef iaf_bw_2003_fr_adaptation_NMDA_H */
